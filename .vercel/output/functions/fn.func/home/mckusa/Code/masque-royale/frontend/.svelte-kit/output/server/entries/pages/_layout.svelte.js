import { c as create_ssr_component, e as escape, a as add_attribute, b as add_styles, d as each, v as validate_component } from "../../chunks/ssr.js";
import { w as writable } from "../../chunks/index2.js";
import { s as setContext, a as split_css_unit, c as compute_slots, b as subscribe } from "../../chunks/lifecycle.js";
  ...
  return ` ${validate_component(Toast, "Toast").$$render($$result, {}, {}, {})}  ${validate_component(AppShell, "AppShell").$$render($$result, {}, {}, {
    header: () => {
      return ` ${validate_component(AppBar, "AppBar").$$render($$result, {}, {}, {
        trail: () => {
          return `<a class="btn btn-sm variant-ghost-surface" href="/" rel="noreferrer" data-svelte-h="svelte-34uy8d">Home</a> `;
        },
        lead: () => {
          return `<strong class="text-xl uppercase" data-svelte-h="svelte-1i40rz9">Masque Royale</strong>`;
        }
      })} `;
    },
    default: () => {
